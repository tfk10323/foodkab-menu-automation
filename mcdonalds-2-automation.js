/**
 * Hyperzod Menu Category Automation - McDonald's Location 2
...
const HYPERZOD_CONFIG = {
  ...
  merchantId: process.env.MCDONALDS_2_MERCHANT_ID
};

// Category configuration for McDonald's Location 2
const CATEGORIES = {
  // Breakfast categories
  breakfast: [
    {
      id: "6885d3be3f603497100dd563",
      name: "Home Style Breakfasts",
      view_type: "list",
      sort_order: 0
    },
    {
      id: "6885d3ba3f603497100dd54d",
      name: "Sandwiches & Meals - Breakfast",
      view_type: "list",
      sort_order: 1
    },
    {
      id: "6885d3bf3f603497100dd568",
      name: "Sides & More",
      view_type: "list",
      sort_order: 2
    },
    {
      id: "6885d3c03f603497100dd570",
...
async function main() {
  ...
  if (!HYPERZOD_CONFIG.apiKey || !HYPERZOD_CONFIG.tenantId || !HYPERZOD_CONFIG.merchantId) {
    ...
    console.error('  - MCDONALDS_2_MERCHANT_ID');
    process.exit(1);
  }
